...
const Register = () => {
  const baseApiLink = process.env.REACT_APP_API_LINK;
  ...
  const onSubmit = async (credential) => {
    ...
    try {
      const data = await fetch(`${baseApiLink}/auth/register`, {
        method: "POST",
        headers: {
  ...
  return (
    <div>
      ...
      <section className="text-gray-600 body-font relative">
        <form
          className="container px-5 py-20 mx-auto flex flex-col justify-center items-center w-[80%] md:w-[30%]"
